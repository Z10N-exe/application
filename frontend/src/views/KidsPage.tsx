...
export function KidsPage() {
  const { data, isLoading } = useQuery({ queryKey: ['kids'], queryFn: () => listProducts({ excludeCategory: 'Women', page: 1, pageSize: 24 }) });
  return (
    <div className="space-y-6">
      <div className="space-y-1">
        <h1 className="text-2xl md:text-3xl font-bold">Kids</h1>
        <p className="text-neutral-600">Durable, comfy shoes built for play and school.</p>
      </div>
