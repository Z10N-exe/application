...
export function CollectionsPage() {
  const { data, isLoading } = useQuery({ queryKey: ['collections'], queryFn: () => listProducts({ page: 1, pageSize: 24, minRating: 4 }) });
  return (
    <div className="space-y-6">
      <div className="space-y-1">
        <h1 className="text-2xl md:text-3xl font-bold">Collections</h1>
        <p className="text-neutral-600">Curated picks: top-rated and trending designs.</p>
      </div>
